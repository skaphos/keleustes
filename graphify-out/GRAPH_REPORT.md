...
## Corpus Check
- 111 files · ~155,653 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1883 nodes · 2178 edges · 147 communities (109 shown, 38 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 98 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dc6a5b06`
...
Cohesion: 0.27
Nodes (12): Marker, Apply(), indexSegment(), joinPath(), matchRule(), pathMatches(), TestApply_PreservesNonSensitiveValues(), TestApply_RedactsSecretDataBlanket() (+4 more)
...
## Knowledge Gaps
- **849 isolated node(s):** `HealthState`, `PromotionMode`, `PromotionPhase`, `SourceType`, `NotifierDeliveryMode` (+844 more)
...
- **Why does `Repo Layout Golden Paths + the `Addon` CRD` connect `Community 54` to `Community 70`, `Community 111`, `Community 47`, `Community 117`, `Community 59`, `Community 62`?**
