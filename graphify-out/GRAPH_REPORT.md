...
## Corpus Check
- 70 files · ~95,461 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1279 nodes · 1438 edges · 117 communities (80 shown, 37 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 47 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e228b498`
...
8. `Extensibility and Plugin Surfaces Plan` - 15 edges
9. `Decision` - 15 edges
10. `Render Contract & Inventory Model` - 14 edges
...
Cohesion: 0.12
Nodes (6): ApplicationSpec, ApplicationStatus, Environment, Promotion, PromotionList, SyncPlanStatus
...
## Knowledge Gaps
- **571 isolated node(s):** `HealthState`, `PromotionMode`, `PromotionPhase`, `SourceType`, `ApprovalDecision` (+566 more)
...
- **Why does `Keleustes Proposal (Draft)` connect `Community 35` to `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 81`, `Community 82`, `Community 54`, `Community 55`, `Community 89`, `Community 26`, `Community 63`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `8. Core concepts` connect `Community 26` to `Community 35`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `SyncRunStatus` connect `Community 22` to `Community 14`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
