...
## Corpus Check
- 71 files · ~99,799 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1327 nodes · 1485 edges · 119 communities (82 shown, 37 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 47 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a71b91eb`
...
3. `RBAC CRD Shapes` - 18 edges
4. `Keleustes Controller Manager` - 18 edges
5. `JetStream Subject and Stream Layout` - 17 edges
6. `Distributed Runtime Architecture Plan` - 17 edges
7. `Observability Stack Plan` - 16 edges
8. `Sharded Controller Pattern` - 16 edges
9. `Extensibility and Plugin Surfaces Plan` - 15 edges
10. `Decision` - 15 edges
...
## Communities (119 total, 37 thin omitted)
...
Cohesion: 0.1
Nodes (6): Source, SourceList, SourceObservedRevision, SourceSpec, SourceType, SourceVerify
...
Cohesion: 0.14
Nodes (3): Promotion, PromotionList, ReleaseList
...
## Knowledge Gaps
- **603 isolated node(s):** `HealthState`, `PromotionMode`, `PromotionPhase`, `SourceType`, `ApprovalDecision` (+598 more)
...
- **Why does `Keleustes Proposal (Draft)` connect `Community 38` to `Community 65`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 103`, `Community 104`, `Community 83`, `Community 84`, `Community 24`, `Community 57`, `Community 56`, `Community 91`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `Source Reconciler` connect `Community 5` to `Community 3`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Source Engine` connect `Community 3` to `Community 5`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
