...
## Corpus Check
- 72 files · ~104,441 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1374 nodes · 1531 edges · 120 communities (83 shown, 37 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 47 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `534b90f5`
...
2. `Audit Event Schema (Versioned)` - 20 edges
3. `Scale Benchmark Harness — Design` - 18 edges
4. `RBAC CRD Shapes` - 18 edges
5. `Keleustes Controller Manager` - 18 edges
...
Cohesion: 0.13
Nodes (5): ApplicationSpec, EnvironmentStatus, Promotion, Release, ReleaseList
...
Cohesion: 0.12
Nodes (4): Application, ApplicationList, PromotionList, SourceObservedRevision
...
## Knowledge Gaps
- **632 isolated node(s):** `HealthState`, `PromotionMode`, `PromotionPhase`, `SourceType`, `ApprovalDecision` (+627 more)
...
- **Why does `Keleustes Proposal (Draft)` connect `Community 39` to `Community 66`, `Community 100`, `Community 101`, `Community 102`, `Community 103`, `Community 104`, `Community 105`, `Community 84`, `Community 85`, `Community 25`, `Community 58`, `Community 92`, `Community 57`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `8. Core concepts` connect `Community 25` to `Community 39`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `SyncRunStatus` connect `Community 36` to `Community 32`, `Community 20`?**
