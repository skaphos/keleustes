...
## Corpus Check
- 69 files · ~90,306 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1234 nodes · 1399 edges · 108 communities (74 shown, 34 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 48 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dfbc24a0`
...
2. `Audit Event Schema (Versioned)` - 19 edges
3. `RBAC CRD Shapes` - 18 edges
4. `Keleustes Controller Manager` - 18 edges
5. `Observability Stack Plan` - 16 edges
6. `Distributed Runtime Architecture Plan` - 16 edges
7. `Extensibility and Plugin Surfaces Plan` - 15 edges
8. `Decision` - 15 edges
9. `Render Contract & Inventory Model` - 14 edges
10. `RBAC, Audit, and the Git-Source-of-Truth Invariant` - 14 edges
...
Cohesion: 0.06
Nodes (43): DuckDB over Parquet Derived Query Layer, Gateway API Tiered Exposure, Hub and Regional Agent Model, NATS JetStream Event Bus, NATS KV Hot Index Layer, NATS Leaf Transport, Content Addressed Object Storage, Regional Agent (+35 more)
...
Cohesion: 0.12
Nodes (6): ApplicationSpec, ApplicationStatus, DeploymentTargetSpec, HealthCheck, HealthCheckList, Release
...
Cohesion: 0.22
Nodes (3): HealthCheckSpec, HealthCheckStatus, HealthState
...
## Knowledge Gaps
- **539 isolated node(s):** `HealthState`, `PromotionMode`, `PromotionPhase`, `SourceType`, `ApprovalDecision` (+534 more)
...
- **Why does `Keleustes Proposal (Draft)` connect `Community 36` to `Community 96`, `Community 91`, `Community 76`, `Community 77`, `Community 83`, `Community 52`, `Community 53`, `Community 23`, `Community 59`, `Community 92`, `Community 93`, `Community 94`, `Community 95`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `8. Core concepts` connect `Community 23` to `Community 36`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Source Reconciler` connect `Community 5` to `Community 2`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
