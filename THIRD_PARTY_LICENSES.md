...
| `github.com/gogo/protobuf` | BSD-3-Clause | [link](https://github.com/gogo/protobuf/blob/v1.3.2/LICENSE) |
| `github.com/google/btree` | Apache-2.0 | [link](https://github.com/google/btree/blob/v1.1.3/LICENSE) |
...
| `k8s.io/api` | Apache-2.0 | [link](https://github.com/kubernetes/api/blob/v0.34.0/LICENSE) |
| `k8s.io/apiextensions-apiserver/pkg/apis/apiextensions` | Apache-2.0 | [link](https://github.com/kubernetes/apiextensions-apiserver/blob/v0.34.0/LICENSE) |
| `k8s.io/apimachinery/pkg` | Apache-2.0 | [link](https://github.com/kubernetes/apimachinery/blob/v0.34.0/LICENSE) |
| `k8s.io/apimachinery/third_party/forked/golang` | BSD-3-Clause | [link](https://github.com/kubernetes/apimachinery/blob/v0.34.0/third_party/forked/golang/LICENSE) |
| `k8s.io/client-go` | Apache-2.0 | [link](https://github.com/kubernetes/client-go/blob/v0.34.0/LICENSE) |
...
| `sigs.k8s.io/controller-runtime` | Apache-2.0 | [link](https://github.com/kubernetes-sigs/controller-runtime/blob/v0.22.0/LICENSE) |
