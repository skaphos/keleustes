...
| `github.com/go-openapi/jsonpointer` | Apache-2.0 | [link](https://github.com/go-openapi/jsonpointer/blob/v0.21.0/LICENSE) |
| `github.com/go-openapi/jsonreference` | Apache-2.0 | [link](https://github.com/go-openapi/jsonreference/blob/v0.20.2/LICENSE) |
| `github.com/go-openapi/swag` | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/v0.23.0/LICENSE) |
...
| `github.com/mailru/easyjson` | MIT | [link](https://github.com/mailru/easyjson/blob/v0.7.7/LICENSE) |
...
| `k8s.io/api` | Apache-2.0 | [link](https://github.com/kubernetes/api/blob/v0.36.0/LICENSE) |
| `k8s.io/apiextensions-apiserver/pkg/apis/apiextensions` | Apache-2.0 | [link](https://github.com/kubernetes/apiextensions-apiserver/blob/v0.36.0/LICENSE) |
| `k8s.io/apimachinery/pkg` | Apache-2.0 | [link](https://github.com/kubernetes/apimachinery/blob/v0.36.0/LICENSE) |
| `k8s.io/apimachinery/third_party/forked/golang` | BSD-3-Clause | [link](https://github.com/kubernetes/apimachinery/blob/v0.36.0/third_party/forked/golang/LICENSE) |
| `k8s.io/client-go` | Apache-2.0 | [link](https://github.com/kubernetes/client-go/blob/v0.36.0/LICENSE) |
...
| `sigs.k8s.io/controller-runtime` | Apache-2.0 | [link](https://github.com/kubernetes-sigs/controller-runtime/blob/v0.24.0/LICENSE) |
